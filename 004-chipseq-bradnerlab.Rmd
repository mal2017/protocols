...
8. Reverse crosslinks (Day 2)
    + Resuspend in 48ul Elution Buffer.
...
9. Purification (Day 3)
    + Add 50ul TE to each tube.
    + Add RNase A to a final concentration of 0.2mg/ml (2ul if stock is 10mg/ml).
    + Mix gently and incubate at 37c for 2hrs.
    + Add 1.75ul 300mM CaCl~2~ in 10mM Tris-HCL, pH8.
    + Add Proteinase K to a concentration of 0.2mg/ml (1ul if stock is 20mg/ml).
