...
## Workflow {-}
<!--html_preserve--><div id="htmlwidget-ad587444ecfea52ccc4e" style="width:10in;height:3.5in;" class="grViz html-widget"></div>
<script type="application/json" data-for="htmlwidget-ad587444ecfea52ccc4e">{"x":{"diagram":"\ndigraph ChIP {\n  node [shape = oval]\n  \"Cultured Cells\";  \n  node [shape = record]\n  \"Fixation\"; \"Lysis\"; \"Sonication\"; \"IP\";\"Wash + Purification\"\n  \n  \"Cultured Cells\" -> \"Fixation\"\n  \"Fixation\" -> \"Lysis\"\n  \"Lysis\" -> \"Sonication\"\n  \"Sonication\" -> \"IP\"\n  \"IP\" -> \"Wash + Purification\"\n}\n","config":{"engine":"dot","options":null}},"evals":[],"jsHooks":[]}</script><!--/html_preserve-->
